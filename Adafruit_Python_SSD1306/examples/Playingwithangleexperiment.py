...
def clkClicked3(channel):
    ...
    if clkState3 ==0 and dtState3 ==1:
        ...
        if (counter == 3 and paused == True):
            ...
            Setup(5)
            Setup(12)
            clockwise(10,20,counter3*10,.0208/50*abs(counter2),16,1)
            sleep(.5)
        ...
        #Stepper three clockwise loop
            ...
            Setup(11)
            Setup(5)
            clockwise(9,20,counter3*10,.0208/(50*abs(counter2)),16,1)
            sleep(.5)
        ...
        #Stepper four clockwise loop
            ...
            Setup(5)
            Setup(12)
            clockwise(11,20,counter3*10,.0208/(50*abs(counter2)),16,1)
            sleep(.5)
        ...
        #Stepper five clockwise loop 
            ...
            Setup(11)
            Setup(12)
            clockwise(5,20,counter3*10,.0208/(50*abs(counter2)),16,1)
            sleep(.5)
        
        #Stepper 6 Loop
        elif(counter == 18 and paused == True):
            Setup(22)
            Setup(10)
            Setup(9)
            Setup(11)
            Setup(5)
            clockwise(12,20,counter3*10,.0208/(50*abs(counter2)),16,1)
            sleep(.5)
...
def dtClicked3(channel):
    ...
    if clkState3 == 1 and dtState3 == 0:
        ...
        if(counter ==3 and paused == False):            
            Setup(22)
            Setup(9)
            Setup(11)
            Setup(5)
            Setup(12)
            clockwise(10,20,counter3*10,.0208/abs(counter2),16,0)
            sleep(.5)
        
        #Stepper two CCW loop 
            ...
            Setup(5)
            Setup(12)
            clockwise(22,20,5000, .0208/(50*abs(counter2)),16,0)
            sleep(.5)
        
        #STepper three CCW Loop
            ...
            Setup(5)
            Setup(12)
            clockwise(9,20,counter3*10, .0208/(50*abs(counter2)),16,0)
            sleep(.5)
        
        #Stepper four CCW loop 
            ...
            Setup(5)
            Setup(12)
            clockwise(11,20,counter3*10, .0208/(50*abs(counter2)),16,0)
            sleep(.5)
            
        #Stepper five CCW Loop 
            ...
            Setup(11)
            Setup(12)
            clockwise(5,20,counter3*10, .0208/(50*abs(counter2)),16,0)
            sleep(.5)
        
        #Stepper 6 CCW Loop
        elif (counter == 18 and paused == False):
            Setup(22)
            Setup(10)
            Setup(9)
            Setup(11)
            Setup(5)   
            clockwise(12,20,counter3*10, .0208/(50*abs(counter2)),16,0)
            sleep(.5)
