...
def swClicked(channel):
    ...
    if (counter == 3 and paused == True):
        clockwise(22,20,10000,.0208/(50*counter2),16,1)
        sleep(.5)
    #vice versa of if statement sending it back to orginal location
    elif (counter ==3 and paused == False):
        clockwise(22,20,10000,.0208/(50*counter2),16,0)
        sleep(.5)
        
    #Stepper 2
    #second stepper value for CW
    if (counter == 6 and paused == True):
        clockwise(10,20,5000, .0208/(50*counter2),16,1)
        sleep(.5)
    #second stepper value for CCW
    elif (counter == 6 and paused == False):
        clockwise(10,20,5000, .0208/(50*counter2),16,0)
        sleep(.5)
    
    #Stepper 3 
    if (counter == 9 and paused == True):
        clockwise(9,20,1000,.0208/(50*counter2),16,1)
        sleep(.5)
    #vice versa of if statement sending it back to orginal location
    elif (counter ==9 and paused == False):
        clockwise(9,20,1000,.0208/(50*counter2),16,0)
        sleep(.5)

    #Stepper 4     
    if (counter == 12 and paused == True):
        clockwise(11,20,1000,.0208/(50*counter2),16,1)
        sleep(.5)
    #vice versa of if statement sending it back to orginal location
    elif (counter ==12 and paused == False):
        clockwise(11,1000,.0208/(50*counter2),16,0)
        sleep(.5)
        
    #Stepper 5     
    if (counter == 15 and paused == True):
        clockwise(5,1000,.0208/(50*counter2),16,1)
        sleep(.5)
    #vice versa of if statement sending it back to orginal location
    elif (counter ==15 and paused == False):
        clockwise(5,1000,.0208/(50*counter2),16,0)
        sleep(.5)
        
    if (counter == 18 and paused == True):
        clockwise(12,1000,.0208/(50*counter2),16,1)
        sleep(.5)
    #vice versa of if statement sending it back to orginal location
    elif (counter ==158 and paused == False):
        clockwise(12,1000,.0208/(50*counter2),16,0)
        sleep(.5)
